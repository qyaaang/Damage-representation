...
class Segmentation:
    ...
    def __init__(self, base_path, folders, white_noise, len_seg):
        ...
        self.data = pd.read_excel('{}/{}/{}'
                                  .format(base_path, white_noise, folders[white_noise]),
                                  skiprows=[0, 1, 3])
    ...
    def seg_signal(self, sensor_name):
        """
        Segment signal
        :param sensor_name: Sensor name eg. AC1N101
...
class FFT:
    ...
    @staticmethod
    def fft(data, sampling_rate=240):
...
if __name__ == '__main__':
    data_path = '/Users/qunyang/Dropbox (Personal)' \
                '/Dataset/DesignSafe-CI/UCSD'
    with open('../data/info/folders.json') as f:
        folders = json.load(f)
    seg = Segmentation(data_path, folders, 'WN1', 400)
    a = seg.write_signal('AC1N101')
